...
The primary [bitcoinblack](https://bitcoinblack.io) wallet; a cross-platform, nice-looking wallet implementation.
...
* `git clone https://github.com/bitcoinblack/bitcoinblack_wallet.git`
* `cd bitcoin_wallet
* `yarn install`
...
### Standalone node
* Make sure you have `bitcoinblack_node` running with the following settings:
  * `"rpc_enable: "true"`
  * `"port": "55000"`
  * `"enable_control": "true"`
* Run `yarn start`
